...
const Cards = () => {
  return (
    <div className='w-full py-[5rem] md:py-[13rem] bg-white'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8  p-6'>
        <div className='flex flex-col w-full p-4 my-4 duration-200 rounded-lg shadow-xl hover:scale-105' data-aos="fade-down-right"
  >
          <img
        ...
        <div className='flex flex-col w-full p-4 my-8 duration-200 bg-gray-100 rounded-lg shadow-xl md:my-0 hover:scale-105' data-aos="fade-down-right"
>
          <img
